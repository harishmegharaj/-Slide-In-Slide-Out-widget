...
public class Microflows
{
	...
	public static boolean aSU(IContext context)
	{
		try
		{
			...
			return (Boolean)Core.execute(context, "Administration.ASU", params);
		}
	...
	public static administration.proxies.Account dS_GetDemoAccount(IContext context)
	{
		try
		{
			Map<String, Object> params = new HashMap<String, Object>();
			IMendixObject result = (IMendixObject)Core.execute(context, "Administration.DS_GetDemoAccount", params);
